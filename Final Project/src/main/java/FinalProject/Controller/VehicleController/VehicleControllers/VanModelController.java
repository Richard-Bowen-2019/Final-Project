 ...
 * @author Richard
 */
public class VanModelController extends VehicleController implements ControllerInterface{
    
    public VanModelController(List<VertexModel> route)throws InterruptedException, IOException
    {
        super();
        this.route = route;
        this.vehicleModel = new VanModel();
        this.vehicleViewInterface = new VanView(route.get(0).getLabel());
        setUpFirst();
    }
